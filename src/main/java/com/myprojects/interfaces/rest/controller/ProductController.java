package com.myprojects.interfaces.rest.controller;

import com.myprojects.application.config.MessageResourceConfig;
import com.myprojects.common.utility.ResponseUtility;
...
public class ProductController {
    ...
    public ResponseEntity<ResponseTemplate<ProductResponse>> createOrUpdateProduct(
        ...
        log.info("Response to the request create or update the product is {}.", productResponse);
        return new ResponseEntity<>(
                ResponseUtility.generateResponse(productResponse, HttpStatus.OK.value(), message),
                HttpStatus.OK
        );
    ...
    public void validateProductRequest(CreateProductRequest createProductRequest) {
        log.info("Validating product request: {}", createProductRequest);
        if (ObjectUtils.isEmpty(createProductRequest.getTitle()) || ObjectUtils.isEmpty(createProductRequest.getPrice())
                || ObjectUtils.isEmpty(createProductRequest.getCategory()) || ObjectUtils.isEmpty(createProductRequest.getImage())) {
